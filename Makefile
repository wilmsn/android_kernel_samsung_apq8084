...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-format-security -Wno-unused-variable -Wno-misleading-indentation -Wno-discarded-array-qualifiers \
		   -Wno-maybe-uninitialized -Wno-uninitialized \
		   -Wno-error=maybe-uninitialized -Wno-error=switch-unreachable -Wno-error=bool-compare \
		   -Wno-error=int-conversion -Wno-error=format-truncation \
